...
@Listeners(listeners.ListenersCoverFox.class)
public class Validate_result_for_healthCare2_forSSofFailedTestcases extends Base{
  ...
  public void validateResultFromTextAndBanner() throws InterruptedException, IOException
	{   Thread.sleep(6000);
		...
		Reporter.log("fetching result from banner", true);
	     ...
	     Thread.sleep(6000);
	     Assert.assertNotEquals(textResult, bannerResult,"textResult & bannerResult are not matched, TC is failed");
